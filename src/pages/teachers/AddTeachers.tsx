...
const AddTeachers: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const requiredFields = [
      ...
      'religion', 'email', 'class', 'section', 'admissionId', 'phone', 'bio'
    ];
  ...
  return (
    <div className="p-4">
        <div className="row">
      <h4 className="mb-4">Add New Teacher</h4>
      <Form onSubmit={handleSubmit}>
        ...
        <Row className="mb-3">
          <Col md={3}><Form.Control name="roll" placeholder="Roll" value={formData.roll} onChange={handleChange} isInvalid={!!errors.roll} />
        ...
        <Row className="mb-3">
          ...
          <Col md={3}><Form.Control name="admissionId" placeholder="Admission ID" value={formData.admissionId} onChange={handleChange} isInvalid={!!errors.admissionId} />
